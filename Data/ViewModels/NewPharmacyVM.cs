...
namespace Neerogilksample.Models
{
    public class NewPharmacyVM
    {
        ...
        [Required]
        public string LocatedNearestCity { get; set; }
        ...
        [Display(Name = "GeoCoordinates GoogleLocation")]
        ...
        [Display(Name = "Select Delivery Persons(s)")]
        [Required(ErrorMessage = "Delivery Person(s) is required")]
        public List<int> DeliveryPersonIds { get; set; }
    }
}
